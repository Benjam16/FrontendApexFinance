...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      ...
      'CATACOMBS-FTM-LP': ['0xe2fca9A2FA9C5290aba6ab0081a1d9A7EdBa2523', 18],
      'CSHARE-FTM-LP': ['0x2764feaBa0675f054f2482B1866aD4C08849B238', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
    masonryLaunchesAt: new Date('2020-12-11T00:00:00Z'),
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  ApexFtmLPApexRewardPool: {
    ...
    poolId: 0,
    sectionInUI: 1,
    contract: 'CatacombsFtmLPCatacombsRewardPool',
  ...
  ApexFtmLPAShareRewardPool: {
    ...
    poolId: 0,
    sectionInUI: 2,
    contract: 'CatacombsFtmLPAChareRewardPool',
    depositTokenName: 'CATACOMBS-FTM-LP',
  ...
  AshareFtmLPAShareRewardPool: {
    ...
    poolId: 1,
    sectionInUI: 2,
    contract: 'CshareFtmLPAChareRewardPool',
